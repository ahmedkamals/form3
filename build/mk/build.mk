...
get-deps: mods-download ## to get required dependencies.
...
mods-download: ## to download all required modules.
	printf "$(OK_CLR)$(MSG_PRFX) Installing required modules$(MSG_SFX)$(NO_CLR)\n"
	GO111MODULE=on $(GO) mod download $(GO_FLAGS) 2>&1
